...
${OBJECTDIR}/deck.o: deck.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deck.o deck.c

${OBJECTDIR}/edge.o: edge.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/edge.o edge.c

${OBJECTDIR}/group.o: group.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/group.o group.c

${OBJECTDIR}/historical.o: historical.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/historical.o historical.c
...
${OBJECTDIR}/vertice.o: vertice.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vertice.o vertice.c
...
${OBJECTDIR}/deck_nomain.o: ${OBJECTDIR}/deck.o deck.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deck_nomain.o deck.c;\
	else  \
...
${OBJECTDIR}/edge_nomain.o: ${OBJECTDIR}/edge.o edge.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/edge_nomain.o edge.c;\
	else  \
...
${OBJECTDIR}/group_nomain.o: ${OBJECTDIR}/group.o group.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/group_nomain.o group.c;\
	else  \
...
${OBJECTDIR}/historical_nomain.o: ${OBJECTDIR}/historical.o historical.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/historical_nomain.o historical.c;\
	else  \
...
${OBJECTDIR}/vertice_nomain.o: ${OBJECTDIR}/vertice.o vertice.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vertice_nomain.o vertice.c;\
	else  \
