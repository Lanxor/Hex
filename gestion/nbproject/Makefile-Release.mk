...
${TESTDIR}/tests/test_deck.o: tests/test_deck.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_deck.o tests/test_deck.c


${TESTDIR}/tests/test_edge.o: tests/test_edge.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_edge.o tests/test_edge.c


${TESTDIR}/tests/test_vertice.o: tests/test_vertice.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_vertice.o tests/test_vertice.c
